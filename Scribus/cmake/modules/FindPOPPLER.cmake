IF (${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION} LESS 2.5)
 ...
 ELSE (${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION} LESS 2.5)
	...
	pkg_search_module(POPPLER libpoppler>=0.20.0 poppler>=0.20.0)
 ENDIF (${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION} LESS 2.5)
FIND_PATH(POPPLER_INCLUDE_DIR 
  NAMES poppler-config.h
  PATHS ${PKG_POPPLER_INCLUDE_DIRS} ${POPPLER_INCLUDE_DIRS} /opt/include
...
FIND_LIBRARY(POPPLER_LIBRARY
  ...
  PATHS ${PKG_POPPLER_LIBRARIES} ${POPPLER_LIBRARY_DIRS} /opt/local/lib /opt/lib /opt/lib/${CMAKE_LIBRARY_ARCHITECTURE}
  PATH_SUFFIXES poppler
  NO_DEFAULT_PATH
)
IF (POPPLER_LIBRARY)
