...
ATTRDEF(QString, bulletChStyleName, BulletChStyleName, "")
ATTRDEF(QString, bulletStr, BulletStr, "")
ATTRDEF(double, bulletFirst, BulletFirst, 0.0)
ATTRDEF(double, bulletIndent, BulletIndent, 0.0)
ATTRDEF(double, bulletTab, BulletTab, 0.0)
ATTRDEF(bool, hasNum, HasNum, false)
ATTRDEF(int, numStyle, NumStyle, 0)
ATTRDEF(QString, numPrefix, NumPrefix, ".")
ATTRDEF(QString, numSuffix, NumSuffix, " ")
ATTRDEF(int, numLevel, NumLevel, 0)
ATTRDEF(double, numFirst, NumFirst, 0.0)
ATTRDEF(double, numIndent, NumIndent, 0.0)
ATTRDEF(double, numTab, NumTab, 0.0)
